...
FD1,mutect2,../../../data-test/WGS/WGS_FD_1.bwa.muTect2.vcf,no"

# T2: Comparación de callers
create_samplesheet "$EXEC_DIR/T2_multiCaller_IL1/annomaf/samplesheet.csv" \
"sample,variantcaller,path,lb_bam
IL1,mutect2,../../../data-test/WGS/WGS_IL_1.bwa.muTect2.vcf,no
IL1,sniper,../../../data-test/WGS/WGS_IL_1.bwa.somaticSniper.vcf,no
IL1,strelka,../../../data-test/WGS/WGS_IL_1.bwa.strelka.vcf,no"
